...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiYXNoaWt0bSIsImEiOiJja3lyNmk2Z3AwcmFlMm9tdnhnb2w4aGRtIn0.86Hyqlmaxs1rgi-z2Vbrcg";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/ashiktm/ckyr8ztqwp4d115nu02z7tnlw",
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            console.log("ss", _context2.t0.response);
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_51KO3NBLEVZIbGTluyHBxcRfAqQQoM6XGqdZkSynGqWcBmLFmTgUho0xgE0trSZ2srIBYTQvRR0qCGRPfGxWhoElf00iTzhvdzI");
            _context.prev = 1;
            _context.next = 4;
